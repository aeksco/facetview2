            ...
            <form class="form-inline">\
                <div class="input-group">\
                    <span class="btn-group">\
                        <button class="btn btn-secondary btn-sm facetview_morefacetvals" id="facetview_facetvals_{{FILTER_NAME}}" title="Filter list size" href="{{FILTER_EXACT}}">0</button> \
                        <button class="btn btn-secondary btn-sm facetview_sort" id="facetview_sort_{{FILTER_NAME}}" title="Filter value order" href="{{FILTER_EXACT}}"></button> \
                        <button class="btn btn-secondary btn-sm facetview_or" id="facetview_or_{{FILTER_NAME}}" href="{{FILTER_EXACT}}">OR</button> \
                    </span>\
                </div>\
            </form>\
        </div>';
...
function setResultsOrder(options, context, order) {
    if (order === 'asc') {
        $('.facetview_order', context).html('<i class="fa fa-arrow-up"></i>');
        ...
        $('.facetview_order', context).html('<i class="fa fa-arrow-down"></i>');
...
function setUIFacetSort(options, context, params) {
    ...
    if (facet.order === "reverse_term") {
        el.html('a-z <i class="fa fa-arrow-up"></i>');
    } else if (facet.order === "count") {
        el.html('count <i class="fa fa-arrow-down"></i>');
    } else if (facet.order === "reverse_count") {
        el.html('count <i class="fa fa-arrow-up"></i>');
    } else if (facet.order === "term") {
        el.html('a-z <i class="fa fa-arrow-down"></i>');
    }
}
